@props(['width' => '40', 'height' => '40', 'stroke' => 'var(--primary-500)'])
<svg width="{{ $width }}" height="{{ $height }}" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15 23.75H25" stroke="{{ $stroke }}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M15 18.75H25" stroke="{{ $stroke }}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
    <path

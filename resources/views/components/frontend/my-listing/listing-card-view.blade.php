<div
    class="relative dark:bg-white w-full rounded-lg p-4 shadow-[0px_2px_4px_0px_rgba(28,33,38,0.03)] flex flex-col transition-all duration-100  gap-6 border border-gray-100 hover:listing-card-gradient ">
                            ...
                            <ul
                                ...
                                <li>
                                    @if ($userPlan->featured_limit > 0)
                                        @if ($ad->featured)
                                            <!-- User has a featured ad -->
                                            <div
                                                class="gap-x-[0.5rem] w-full body-md-400 text-gray-700 hover:text-gray-900 hover:bg-primary-50 transition-all duration-150 flex items-center px-4 py-[0.62rem]">
                                                <i class="fa-regular fa-star text-xl"></i>
                                                <span class="text-sm font-medium">{{ __('featured') }}</span>
                                            </div>
                                        @else
                                            <!-- User has featured ad limit, but this ad is not featured -->
                                            <form method="POST"
                                                action="{{ route('frontend.promote-as-featured', $ad->slug) }}">
                                                @csrf
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <i class="fa-regular fa-star text-xl"></i>
                                                    <span
                                                        class="text-sm font-medium">{{ __('promote_ad_as_featured') }}</span>
                                                </button>
                                            </form>
                                        @endif
                                    @elseif ($ad->featured)
                                        <!-- User has no ad limit, and this ad is featured -->
                                        <div
                                            class="gap-x-[0.5rem] w-full body-md-400 text-gray-700 hover:text-gray-900 hover:bg-primary-50 transition-all duration-150 flex items-center px-4 py-[0.62rem]">
                                            <i class="fa-regular fa-star text-xl"></i>
                                            <span class="text-sm font-medium">{{ __('featured') }}</span>
                                    ...
                                    @else
                                        ...
                                        <a href="{{ route('frontend.plans-billing') }}"
                                            ...
                                            <i class="fa-regular fa-star text-xl"></i>
                                            <span
                                                class="text-sm font-medium">{{ __('featured_limit_crossed_update_plan') }}</span>
                                        </a>
                                    @endif
                                </li>
    ...
    <div class="flex flex-wrap gap-2 mt-2">
        <span class="text-xs bg-primary-100 px-2 py-0.5 rounded">Top Ad</span>
        <span class="text-xs bg-primary-100 px-2 py-0.5 rounded">Bump Up</span>
        <span class="text-xs bg-primary-100 px-2 py-0.5 rounded">Featured</span>
        <span class="text-xs bg-primary-100 px-2 py-0.5 rounded">Urgent</span>
        <span class="text-xs bg-primary-100 px-2 py-0.5 rounded">Highlighted</span>
    </div>

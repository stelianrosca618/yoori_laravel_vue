        ...
        <form id="watermarkForm" class="form-horizontal" action="{{ route('settings.general.watermark.update') }}"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h6>
                        {{ __('watermark_on_ads_images') }}
                    </h6>
                    <h6>
                        <input type="checkbox" id="status" {{ $setting->watermark_status ? 'checked' : '' }} name="watermark_status"
                            data-bootstrap-switch data-on-color="success" data-on-text="{{ __('on') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <select name="watermark_type"
                                    ...
                                    <option {{ $setting->watermark_type == 'text' ? 'selected' : '' }} value="text">
                                        {{ __('text') }}
                                    </option>
                                    <option {{ $setting->watermark_type == 'image' ? 'selected' : '' }} value="image">
                                        {{ __('image') }}
                                    </option>
                                </select>
                        ...
                        <div id="image-div" class="{{ $setting->watermark_type == 'image' ? '' : 'd-none' }}">
                            ...
                            <div class="pt-4 form-group row text-center d-flex align-items-center">
                                <div class="offset-6 col-sm-12 col-md-6">
                                    <img id="image" width="100" src="{{ asset($setting->watermark_image) }}"
                                        alt="">
                                </div>
                            </div>
                        </div>

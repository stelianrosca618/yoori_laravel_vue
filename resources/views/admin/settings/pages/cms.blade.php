            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-2">
                    <ul class="nav nav-pills flex-column" id="cms-pills-tab" role="tablist">
                        ...
                        <li class="nav-item border rounded mb-1" role="presentation">
                            <a class="nav-link {{ $cms_tab == 'promotions' ? 'active' : '' }}" id="promotions-tab"
                                data-toggle="pill" href="#cms-promotions" role="tab" aria-controls="promotions"
                                aria-selected="false">{{ __('promotions') }}
                            </a>
                        </li>
                        ...
                        <li class="nav-item border rounded mb-1" role="presentation">
                            <a class="nav-link {{ $cms_tab == 'refund' ? 'active' : '' }}" id="refund-tab"
                                data-toggle="pill" href="#cms-refund" role="tab" aria-controls="refund"
                                aria-selected="false">{{ __('refund_policy') }}
                            </a>
                        </li>
                        <li class="nav-item border rounded mb-1" role="presentation">
                        ...
                        <li class="nav-item border rounded mb-1" role="presentation">
                            <a class="nav-link {{ $cms_tab == 'blog' ? 'active' : '' }}" id="blog-tab"
                                data-toggle="pill" href="#cms-blog" role="tab" aria-controls="blog"
                                aria-selected="false">{{ __('blog') }}</a>
                        </li>
                        <li class="nav-item border rounded mb-1" role="presentation">
                            <a class="nav-link {{ $cms_tab == 'ads' ? 'active' : '' }}" id="ads-tab"
                                data-toggle="pill" href="#cms-ads" role="tab" aria-controls="ads"
                        ...
                        <li class="nav-item border rounded mb-1" role="presentation">
                            <a class="nav-link {{ $cms_tab == 'faq' ? 'active' : '' }}" id="faq-tab"
                                data-toggle="pill" href="#cms-faq" role="tab" aria-controls="faq"
                ...
                <div class="col-12 col-sm-12 col-md-10">
                    <div class="tab-content" id="cms-pills-tabContent">
                        ...
                        <div class="tab-pane fade  {{ $cms_tab == 'home' ? 'show active' : '' }}" id="cms-home"
                            ...
                            <x-backend.setting.cms.home-setting :sliders="$sliders" />
                        </div>

                        {{-- About Settings --}}
                        <div class="tab-pane fade {{ $cms_tab == 'about' ? 'show active' : '' }}" id="cms-about"
                            role="tabpanel" aria-labelledby="about-tab">
                            <x-backend.setting.cms.about-setting :aboutcontent="$cms->about_body" :aboutVideoThumb="$cms->about_video_thumb" :aboutVideoUrl="$cms->about_video_url"
                                :aboutSliders="$aboutSliders" />
                        </div>

                        {{-- Promotions Page CMS Settings --}}
                        <div class="tab-pane fade {{ $cms_tab == 'promotions' ? 'show active' : '' }}"
                            id="cms-promotions" role="tabpanel" aria-labelledby="promotions-tab">
                            <x-backend.setting.cms.promotions-setting 
                            :promotionBannerTitle="$cms->promotion_banner_title" :promotionBannerText="$cms->promotion_banner_text" :promotionBannerImg="$cms->promotion_banner_img"

                            :featuredTitle="$cms->featured_title" :featuredText="$cms->featured_text" :featuredImg="$cms->featured_img"

                            :urgentTitle="$cms->urgent_title" :urgentText="$cms->urgent_text" :urgentImg="$cms->urgent_img"

                            :highlightTitle="$cms->highlight_title" :highlightText="$cms->highlight_text" :highlightImg="$cms->highlight_img"

                            :topTitle="$cms->top_title" :topText="$cms->top_text" :topImg="$cms->top_img"

                            :bumpUpTitle="$cms->bump_up_title" :bumpUpText="$cms->bump_up_text" :bumpUpImg="$cms->bump_up_img"

                            :promotionContent="$promotion_page_content"
                            />
                        </div>
                        ...
                        {{-- Refund Settings --}}
                        <div class="tab-pane fade {{ $cms_tab == 'refund' ? 'show active' : '' }}" id="cms-refund"
                            role="tabpanel" aria-labelledby="posting-tab">
                            <x-backend.setting.cms.refund-policy-setting :refund="$cms->refund_body" :refundContent="$refund_page_content"
                                :refundBackground="$cms->refund_background" />
                        </div>
                        ...
                        <div class="tab-pane fade {{ $cms_tab == 'price_plan' ? 'show active' : '' }}"
                            ...
                            {{-- @dd($price_plan_services); --}}
                            <x-backend.setting.cms.pricing-plan :cms="$cms" :pricePlanServices="$price_plan_services" />
                        </div>
                        {{-- Blog --}}
...
@push('script')
    ...
    <script>
        ...
        ClassicEditor
            .create(document.querySelector('#refund_ck'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#promotions_ck'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#featured_ck'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#urgent_ck'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#highlight_ck'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#top_ck'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#bump_up_ck'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor

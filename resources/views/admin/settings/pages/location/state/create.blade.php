...
@section('title') {{ __('create_state') }} @endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('create_state') }}</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('settings.location.state.store') }}" method="POST">
                                @csrf
                                <div class="form-group row">
                                    <x-forms.label name="country" required="true" class="col-sm-3" />
                                    <div class="col-sm-9">
                                        <select name="country_id" class="select2bs4 w-100 @error('state_id') is-invalid @enderror">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="state_name" value="" placeholder="Enter City Name" required>
                                        
                                    </div>
                                    @error('state_name') <span class="invalid-feedback"
                                    role="alert"><strong>{{ $message }}</strong></span> @enderror
                                </div>
                                <div class="form-group row">

            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('update_state') }}</h3>
                        <a href="{{ route('settings.location.state.state') }}"
                            class="btn bg-primary float-right d-flex align-items-center justify-content-center"><i
                                class="fas fa-arrow-left"></i>&nbsp; {{ __('back') }}</a>
                    </div>
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('settings.location.state.update', $state->id) }}" method="POST">
                                @csrf
                                @method('PUT') <!-- Use PUT or PATCH method for updating -->
                                <div class="form-group row">
                                    <x-forms.label name="country" required="true" class="col-sm-3" />
                                    <div class="col-sm-9">
                                        <select name="country_id" class="select2bs4 w-100 @error('country_id') is-invalid @enderror">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="state_name" value="{{ old('state_name', $state->name) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="lat"  value="{{ old('lat', $state->lat) }}" placeholder="Enter latitude " required> 
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="long" value="{{ old('long', $state->long) }}" placeholder="Enter longitude" required>  
                                    </div>

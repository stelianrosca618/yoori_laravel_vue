                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class="card d-inline-block">
                                    <img src="{{ asset('backend/image/theme2.webp') }}" width="500px" height="250px"
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class=" card d-inline-block">
                                    <img src="{{ asset('backend/image/theme1.webp') }}" width="500px" height="250px"
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4">
                                <div class="card d-inline-block">
                                    <img src="{{ asset('backend/image/theme3.webp') }}" class="card-img-top skin-image"

                                ...
                                @if (!is_null($selected_user))
                                    <form id="messageForm">
                                        ...
                                        <div class="input-message--text textarea">
                                            <textarea placeholder="{{ __('type_your_message') }}..." name="body" style="padding-bottom: 10px;" id="messageBodyy"></textarea>
...
@section('frontend_script')
    ...
    <script>
        $('#messageBodyy').on('input', function() {
        ...
        if (messageForm) {
            ...
            messageForm.addEventListener('submit', function(e) {
                ...
                const message = document.getElementById('messageBodyy');
        ...
        //             let message__body = document.querySelector('.message-body');
        //             message__body.scrollTop = message__body.scrollHeight - message__body.clientHeight;
        //         }

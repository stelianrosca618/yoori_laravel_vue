...
@section('title')
    {{ __('edit_listing') }} ({{ __('steps03') }}) - {{ $ad->title }}
@endsection
        ...
        <div class="dashboard-post__step02 step-information">
            ...
            <form action="{{ route('frontend.post.step3.update', $ad->slug) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-field mt-3">
                    <x-forms.label name="video_url" for="video_url" required="false" />
                    <input type="url"  name="video_url" placeholder="{{ __('enter_video_url') }}..." id="video_url"
                      value="{{ $ad->video_url  }}"  class="@error('video_url') border-danger @enderror"/>
                </div>

    ...
    <section class="product-item section">
        <div class="container">
            <div class="row">
                <div class="col-xl-8">
                    {{-- ad badge --}}
                    <x-frontend.ad-details.ad-badge :featured="$ad->featured" :customerid="$ad->user_id" :status="$ad->status" />
                    ...
                    {{-- ad description --}}
                    <x-frontend.ad-details.ad-description :description="$ad->description" :features="$ad->adFeatures" :videourl="$ad->video_url" />
                    </div>
                <div class="col-xl-4">
...
@section('frontend_script')
    <!-- >=>Leaflet Map<=< -->
    <x-map.leaflet.edit-leafletmap :lat="$lat" :long="$long" :marker="false" />

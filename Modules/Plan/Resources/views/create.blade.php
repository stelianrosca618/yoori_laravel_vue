            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-8 pt-3">
                        <form id="form" class="form-horizontal" action="{{ route('module.plan.store') }}"
                            method="POST">
                            @csrf
                                            ...
                                            <div class="d-flex ">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input onclick="changePaymentType()" type="radio" id="one_time_plan"
                                                        ...
                                                        value="one_time" @checked(old('plan_payment_type', 'one_time') == 'one_time')>
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input onclick="changePaymentType()" type="radio" id="recurring_plan"
                                                        name="plan_payment_type" class="custom-control-input"
                                                        value="recurring" @checked(old('plan_payment_type') == 'recurring')>
                                    ...
                                    <div class="col-md-6 recurring_plan">
                                        <div class="form-group">
                                            ...
                                            <select name="interval" class="custom-select mr-sm-2" id="plan_type">
                                                ...
                                                <option {{ old('interval') == 'yearly' ? 'selected' : '' }} value="yearly">
                                                    {{ __('yearly') }}
                                                </option>
                                    ...
                                    <div class="col-md-6 d-none" id="interval_date">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" id="custom_interval_days"
                                                name="custom_interval_days" value="{{ old('custom_interval_days') }}"

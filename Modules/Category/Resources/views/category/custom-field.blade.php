                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('module.category.index', $category->id) }}" class="mr-2 btn btn-secondary">
                                ...
                                @forelse ($fields as $item)
                                    <tr class="custom-field" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="handle btn btn-success mt-0 cursor-move">
                                                <x-svg.drag-icon class="text-primary" />
                                            </div>
                                        </td>
                                    </tr>
                                @empty

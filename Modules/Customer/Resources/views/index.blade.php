                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right d-flex align-items-center justify-content-center">
                            @if ($user->can('verification-request.index'))
                                <a href="{{ route('module.customer.verification.request') }}"
                                    class="position-relative btn bg-info mr-2">
                                    <i class="fas fa-hourglass-start mr-1"></i>
                                    {{ __('verification_request') }}
                            ...
                            @endif
                            <a href="{{ route('module.customer.create') }}" class="btn bg-primary">
                                        ...
                                        <div class="col-sm-12 col-md-4 mt-1 mt-md-0">
                                            ...
                                            @if (request('keyword') || request('filter_by') || request('sort_by') || request('perpage'))
                                                <a href="{{ route('module.customer.index') }}"
                                                    class="btn btn-danger px-4 ml-1" type="submit">
                                                    {{ __('clear') }}
                                                </a>
                                            @endif
                                        </div>
                                ...
                                <table class="table table-hover text-nowrap table-bordered">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th width="10%">{{ __('document_status') }}</th>
                                        ...
                                        @forelse ($customers as $key =>$customer)
                                            <tr>
                                                ...
                                                <td class="text-center" tabindex="0">
                                                    <a href="{{ route('module.customer.show', $customer->username) }}">
                                                        <img src="{{ $customer->image_url }}" class="rounded"
                                                ...
                                                <td class="text-center">
                                                    @php
                                                        $status_class = $customer->document_verified ? $customer->document_verified->status : '';
                                                    @endphp
                                                    <span
                                                        class="text-capitalize badge badge-{{ $status_class == 'pending' ? 'info' : '' }}{{ $status_class == 'approved' ? 'success' : '' }}{{ $status_class == 'rejected' ? 'danger' : '' }}">
                                                        {{ $customer->document_verified ? $customer->document_verified->status : '-' }}
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <span

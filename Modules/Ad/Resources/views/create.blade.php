                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="icheck-success d-inline mr-3" data-toggle="tooltip"
                                                    ...
                                                    <x-forms.label name="{{ __('featured') }}" class="form-check-label" for="featured" :required="false" />
                                                </div>

                                                <div class="icheck-success d-inline mr-3" data-toggle="tooltip"
                                                    data-original-title="{{ __('promote_listing_as_urgent') }}">
                                                    <input {{ old('urgent') == 1 ? 'checked' : '' }} value="1" name="urgent" type="checkbox" class="form-check-input"
                                                        id="urgent" />
                                                    <x-forms.label name="{{ __('urgent') }}" class="form-check-label" for="urgent" :required="false" />
                                                </div>

                                                <div class="icheck-success d-inline mr-3" data-toggle="tooltip"
                                                    data-original-title="{{ __('promote_listing_as_highlight') }}">
                                                    <input {{ old('highlight') == 1 ? 'checked' : '' }} value="1" name="highlight" type="checkbox" class="form-check-input"
                                                        id="highlight" />
                                                    <x-forms.label name="{{ __('highlight') }}" class="form-check-label" for="highlight" :required="false" />
                                                </div>

                                                <div class="icheck-success d-inline mr-3" data-toggle="tooltip"
                                                    data-original-title="{{ __('promote_listing_as_top') }}">
                                                    <input {{ old('top') == 1 ? 'checked' : '' }} value="1" name="top" type="checkbox" class="form-check-input"
                                                        id="top" />
                                                    <x-forms.label name="{{ __('top') }}" class="form-check-label" for="top" :required="false" />
                                                </div>

                                                <div class="icheck-success d-inline mr-3" data-toggle="tooltip"
                                                    data-original-title="{{ __('promote_listing_as_bump_up') }}">
                                                    <input {{ old('bump_up') == 1 ? 'checked' : '' }} value="1" name="bump_up" type="checkbox" class="form-check-input"
                                                        id="bump_up" />
                                                    <x-forms.label name="{{ __('bump_up') }}" class="form-check-label" for="bump_up" :required="false" />
                                                </div>

            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('listing_details') }}</h3>
                                ...
                                @foreach ($ad->productCustomFields as $field)
                                    <tr class="mb-5">
                                        ...
                                        @if ($field->customField->type == 'file')
                                            <td>
                                                @if ($field->value)
                                                    <a download href="/{{ $field->value }}" class="underline">{{ __('download') }}</a>
                                                @else
                                                    {{ __('no_file_found') }}
                                                @endif
                                            </td>
                                        @elseif ($field->customField->type == 'url')
                                            <td>
                                                <a target="_blank" class="text-sm w-[200px] overflow-hidden whitespace-nowrap text-ellipsis" href="{{ $field->value }}">{{ $field->value }}</a>
                                            </td>
                                        ...
                                        @elseif ($field->customField->type == 'checkbox')
                                            <td>
                                                <span class="body-md-500 text-gray-900">

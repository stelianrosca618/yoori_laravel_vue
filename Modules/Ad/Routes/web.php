...
Route::middleware(['auth:admin', 'set_lang'])->group(function () {
    ...
    Route::group(['as' => 'module.ad.', 'prefix' => 'admin/ad', 'namespace' => 'Auth'], function () {
        ...
        Route::post('/{slug}/Resubmission-Status', [AdController::class, 'ResubmissionStatus'])->name('ResubmissionStatus');
        Route::delete('/resubmission-image/delete/{id}', [AdController::class, 'resubmissionImage'])->name('resubmissionImage');
        Route::get('/resubmission-index', [AdController::class, 'resubmissionIndex'])->name('resubmissionIndex');
        Route::get('/resubmitted-ads', [AdController::class, 'resubmissionIndex'])->name('resubmitted-ads');

                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file d-flex flex-row-reverse">
                                            <input type="file" name="{{ $field->slug }}"
                                                class="form-control custom-file-input @error($field->slug) is-invalid @enderror"
                                                id="customFile">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="{{ $field->slug }}" placeholder="{{ $field->name }}"
                                            class="form-control @error($field->slug) is-invalid @enderror" rows="5">{{ $field->value }}</textarea>
                                        @error($field->slug)
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>

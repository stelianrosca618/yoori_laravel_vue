                    ...
                    <div class="card-header">
                        <div class="row row-cols-1 row-cols-md-2 justify-content-between">
                            ...
                            <div class="col-12 col-md-6 text-md-right">
                                <a href="{{ route('module.custom.field.group.index') }}" class="mb-1 mb-md-0 btn btn-info">
                                    <i class="fas fa-cog"></i>
                                    <span class="ml-1">
                                        {{ __('manage_group') }}
                                    </span>
                                </a>
                                <a href="{{ route('module.custom.field.create') }}" class="mb-1 mb-md-0 btn btn-primary">
                                ...
                                @if (request('category') && request('category') != 'all')
                                    @php
                                        $category = Modules\Category\Entities\Category::find(request('category'));
                                    @endphp

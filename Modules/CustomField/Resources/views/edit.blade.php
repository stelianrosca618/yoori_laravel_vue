            ...
            <div class="card">
                <div class="card-header">
                    <div class="row row-cols-1 row-cols-md-2 justify-content-between">
                        <h3 class="col-12 col-md-6 card-title" style="line-height: 36px;">{{ __('edit_custom_field') }}</h3>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type"
                                                ...
                                                <option {{ old('type', $custom_field->type) == 'text' ? 'selected' : '' }}
                                                    value="text">
                                                    {{ __('text') }}
                                                </option>
                                                <option
                                                ...
                                                <option {{ old('type', $custom_field->type) == 'radio' ? 'selected' : '' }}
                                                    value="radio">
                                                    {{ __('radio') }}
                                                </option>
                                                <option
                                                ...
                                                <option {{ old('type', $custom_field->type) == 'file' ? 'selected' : '' }}
                                                    value="file">
                                                    {{ __('file') }}
                                                </option>
                                                <option {{ old('type', $custom_field->type) == 'date' ? 'selected' : '' }}
                                                    value="date">
                                                    {{ __('date') }}
                                                </option>

            ...
            <div class="card">
                <div class="card-header">
                    <div class="row row-cols-1 row-cols-md-2 justify-content-between">
                        <h3 class="col-12 col-md-6 card-title" style="line-height: 36px;">{{ __('create_custom_field') }}</h3>
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <form class="form-horizontal" action=" {{ route('module.custom.field.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">

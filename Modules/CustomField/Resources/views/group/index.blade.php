                    ...
                    <div class="card-body">
                        @if ($edit_group && userCan('custom-field-group.update'))
                            <form class="form-horizontal"
                                action="{{ route('module.custom.field.group.update', $edit_group->slug) }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-3 col-sm-12 ">
                                        ...
                                        <a href="{{ route('module.custom.field.group.index') }}" class="btn btn-danger"><i
                                                class="fas fa-times"></i>&nbsp; {{ __('cancel') }}
                                        </a>
                                    </div>
                                </div>
                            </form>

...
class SearchCountryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.settings.pages.location.country.index', ['posts' => $posts]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.settings.pages.location.country.create', ['country' => $country]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.settings.pages.location.country.edit', compact('country'));
    }

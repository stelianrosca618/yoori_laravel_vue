...
class StateController extends Controller
{
    public function index()
    {
        ...
        return view('admin.settings.pages.location.state.index', ['countries' => $countries, 'states' => $states]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.settings.pages.location.state.create', ['countries' => $countries]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.settings.pages.location.state.edit', compact('state', 'countries'));
    }

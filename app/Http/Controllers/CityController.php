...
class CityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.settings.pages.location.city.index', ['categories' => $categories, 'posts' => $posts]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.settings.pages.location.city.create', ['states' => $states]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.settings.pages.location.city.edit', compact('city', 'states'));
    }
